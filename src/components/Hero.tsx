    ...
    <section className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          >
            <motion.button
              className="px-8 py-3 bg-sandy-brown text-white rounded-lg font-medium transition-all duration-300"
            ...
            <motion.button
              className="px-8 py-3 border-2 border-outer-space dark:border-apricot text-outer-space dark:text-apricot rounded-lg font-medium transition-all duration-300"
